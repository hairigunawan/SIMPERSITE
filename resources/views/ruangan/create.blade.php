...
<head>
    ...
    <title>Tambah Ruangan - SIMPERSITE</title>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex flex-col p-4">
                              ...
                              <div class="flex flex-col items-center w-full h-auto gap-6 rounded-lg border-2 border-dashed border-[#cfdbe7] px-6 py-14">
                                    <p class="text-[#0d141b] text-sm font-normal leading-normal max-w-[480px] text-center">Pilih gambar untuk diupload (opsional)</p>
                                    <input type="file" name="gambar" class="block w-full text-sm text-slate-500
                                      file:mr-4 file:py-2 file:px-4
                                      file:rounded-full file:border-0
                                      file:text-sm file:font-semibold
                                      file:bg-green-50 file:text-[#30B280]
                                      hover:file:bg-green-100
                                    "/>
                              </div>
                              {{-- Tombol Submit --}}
                              <div class="flex pr-4 mt-8 items-start">
