    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <div class="card p-3 mb-3 shadow-sm rounded-3">
                <h5 class="fw-bold mb-3">Ruangan</h5>
                <div class="d-flex justify-content-around">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-flex flex-column">
                            <span class="small">Terpakai</span>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-flex flex-column">
                            <span class="small">Perbaikan</span>
        ...
        <div class="col-md-6">
            <div class="card p-3 mb-3 shadow-sm rounded-3">
                <h5 class="fw-bold mb-3">Proyektor</h5>
                <div class="d-flex justify-content-around">
                    <!-- Proyektor Tersedia -->
                    <div class="d-flex align-items-center gap-2">
                        <div class="rounded-circle bg-success bg-opacity-25 d-flex align-items-center justify-content-center" style="width:35px; height:35px;">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card p-3 shadow-sm rounded-3 border-0" 
                 style="border-left: 5px solid {{ $lab->status == 'Terpakai' ? 'red' : ($lab->status == 'Perbaikan' ? 'orange' : 'green') }}">
                <h6 class="fw-bold mb-2">
                    <i class="fa-solid fa-laptop-code text-info"></i> {{ $lab->nama }}
                    <span class="badge {{ $lab->status == 'Terpakai' ? 'bg-danger' : ($lab->status == 'Perbaikan' ? 'bg-warning text-dark' : 'bg-success') }} float-end">
                        {{ $lab->status }}
                    </span>
                </h6>
